...
if _HAS_IDA:
    ...
    _ACTION_DEFS: list[tuple[str, str, Callable, bool, str, str, set[str]]] = [
        (
            ...
            False,
            "Ctrl+Shift+A",
            QCoreApplication.translate("MainWindow", "Send selection or address to Rikugan input"),
            {"disasm", "pseudo"},
        ),
        (
            "rikugan:explain",
            QCoreApplication.translate("MainWindow", "Explain this"),
            _handle_explain,
            True,
            "",
            QCoreApplication.translate("MainWindow", "Explain the current function with Rikugan"),
            {"disasm", "pseudo"},
        ),
        (
            "rikugan:rename",
            QCoreApplication.translate("MainWindow", "Rename with Rikugan"),
            _handle_rename,
            True,
            "",
            QCoreApplication.translate("MainWindow", "Analyze and rename the current function"),
            {"disasm", "pseudo"},
        ),
        (
            "rikugan:deobfuscate",
            QCoreApplication.translate("MainWindow", "Deobfuscate with Rikugan"),
            _handle_deobfuscate,
            True,
            "",
            QCoreApplication.translate("MainWindow", "Deobfuscate the current function"),
            {"disasm", "pseudo"},
        ),
        (
            "rikugan:vuln_audit",
            QCoreApplication.translate("MainWindow", "Find vulnerabilities"),
            _handle_vuln_audit,
            True,
            "",
            QCoreApplication.translate("MainWindow", "Audit the current function for security bugs"),
            {"disasm", "pseudo"},
        ),
        (
            "rikugan:suggest_types",
            QCoreApplication.translate("MainWindow", "Suggest types"),
            _handle_suggest_types,
            True,
            "",
            QCoreApplication.translate("MainWindow", "Infer and apply types for the current function"),
            {"disasm", "pseudo"},
        ),
        (
            "rikugan:annotate",
            QCoreApplication.translate("MainWindow", "Annotate function"),
            _handle_annotate,
            True,
            "",
            QCoreApplication.translate("MainWindow", "Add comments to the current function"),
            {"pseudo"},
        ),
        (
            "rikugan:clean_mcode",
            QCoreApplication.translate("MainWindow", "Clean microcode"),
            _handle_clean_mcode,
            True,
            "",
            QCoreApplication.translate("MainWindow", "Clean the microcode for the current function"),
            {"pseudo"},
        ),
        (
            "rikugan:xref_analysis",
            QCoreApplication.translate("MainWindow", "Xref analysis"),
            _handle_xref_analysis,
            True,
            "",
            QCoreApplication.translate("MainWindow", "Deep cross-reference analysis on the current function"),
            {"disasm", "pseudo"},
        ),
    ]
